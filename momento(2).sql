...
/*Inserindo dados na tabela ocupações */
...
/*Inserindo  meu proprio departamento*/
    INSERT INTO departamento(departamento_id, departamento_name, posicao_id) VALUES (13, 'Product designer', 1800);
...
/*Incluindo meus dados no departamento de tecnologia*/
    ...
    VALUES (207, 'Isabelli', 'Oliveira', 'isabelli.camargo29@gmail.com','11 98098-2265', '2022-06-05',9,7500.00,NULL,6);

/*Incluido meu grupo do demoDay no departamento de administração*/

    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (208, 'Adriano', 'Queiroz', 'adriano.queiroz@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (209, 'Tatiane', 'Mikalkenas', 'tatizinha@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (210, 'Jheniiffer', 'Reis', 'jenni.reis@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id)
    VALUES (211, 'Stefani', 'Farias', 'eufarias@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (212, 'Paulo', 'Mota', 'paulinho@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (213, 'Gabriel', 'Harmony', 'harmonia.gabriel@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
    VALUES (214, 'Francisca', 'Carla', 'frazinha@gmail.com','12 3456-7890', '2022-06-05',3,2500.00,101,1);

/*Incluido novos funcionarios ao departamento de inovações*/
    INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,dataContratacao,ocupacao_id,salario,gerente_id,departamento_id) 
...
/*dependentes da Fabiana*/
    ...
    SELECT paises.pais_name AS Pais, regiao_name FROM paises INNER JOIN regiao wHERE paises.regiao_id = regiao.regiao_id;

    SELECT departamento.primeiro_nome, funcionarios.primeiro_nome
    FROM dependentes
    INNER JOIN funcionarios
    ON dependentes.funcionario_id = funcionario.funcionario_id
    wHERE dependentes.primeiro_nome = 'Joe'

    SELECT departamento.primeiro_nome, funcionarios.primeiro_nome, dependentes.parentesco FROM dependentes
    INNER JOIN funcionarios ON dependentes.funcionario_id = funcionario.funcionario_id
    wHERE dependentes.funcionario_id = '112'

    SELECT regiao.regiao_name, COUNT(paises.regiao_id) FROM paises INNER JOIN regiao wHERE funcionarios.funcionario_id = dependentes.funcionario_id;

    SELECT funcionarios.primeiro_nome, dependentes.primeiro_nome FROM funcionario INNER JOIN dependentes wHERE funcionarios.funcionario_id = dependentes.funcionario_id

    SELECT dependentes.primeiro_nome, funcionario.primeiro_nome, dependentes.parentesco FROM dependentes
